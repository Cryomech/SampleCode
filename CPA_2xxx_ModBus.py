...
def breakdownReplyData(rawData):
    ...
    wkrBytes = bytes([rawData[8], rawData[7], rawData[10], rawData[9]])
    ...
    wkrBytes = bytes([rawData[12], rawData[11], rawData[14], rawData[13]])
...
def main():
    gWindow.title("CPA2.0 Format Modbus")
